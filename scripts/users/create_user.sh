...
function create_user() {
    ...
    mysql -u root -p password -e "create database $username";
    mysql -u root -p password -e "grant usage on *.* to $username@localhost identified by $username;"
    mysql -u root -p password -e "grant all privileges on $username.* to $username@localhost;"
